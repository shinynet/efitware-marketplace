...
const manifest = { formatVersion: 3, version: plugin.version, commit: execFileSync('git', ['rev-parse', 'HEAD'], { encoding: 'utf8' }).trim(), serverContract, skillSha256: sha256(skill), cardSha256: files['workout.html']!.sha256, themeSha256: theme.digest('hex'), files }
